...
environment = ChaseGridWorld(40)
agent = QAgent(environment,name="TestAgentChase25", epsilon=0.0, alpha=0.0, epsilon_decay=lambda x: x*0.99994, alpha_decay=lambda x: x*0.999975)
